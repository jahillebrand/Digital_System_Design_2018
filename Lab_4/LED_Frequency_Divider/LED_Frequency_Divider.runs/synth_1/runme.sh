...
HD_PWD='/home/exposedbuckle48/Documents/Semester_5/DSD/Lab_4/LED_Frequency_Divider/LED_Frequency_Divider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_Frequency_Divider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_Frequency_Divider.tcl
