...
HD_PWD='/home/exposedbuckle48/Documents/Semester_5/DSD/Lab_4/LED_Frequency_Divider/LED_Frequency_Divider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_Frequency_Divider.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED_Frequency_Divider.tcl -notrace
