...
HD_PWD='/home/exposedbuckle48/Documents/Semester_5/DSD/Homework_1/Homework_1/Homework_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_logic_circuit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_logic_circuit.tcl
