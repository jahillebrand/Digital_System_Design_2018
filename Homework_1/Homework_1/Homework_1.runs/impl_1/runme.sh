...
HD_PWD='/home/exposedbuckle48/Documents/Semester_5/DSD/Homework_1/Homework_1/Homework_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_logic_circuit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple_logic_circuit.tcl -notrace
