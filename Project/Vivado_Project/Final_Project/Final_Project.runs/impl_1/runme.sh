...
HD_PWD='/home/exposedbuckle48/Documents/Semester_5/DSD/Project/Vivado_Project/Final_Project/Final_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_24_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clock_24_7seg.tcl -notrace
