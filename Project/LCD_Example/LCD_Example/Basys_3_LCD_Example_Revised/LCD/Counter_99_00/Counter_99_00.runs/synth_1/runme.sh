...
HD_PWD='C:/Teaching_Materials/CEE-325 Fall 2018/Week 13 Digital CLock/New_LCD_Revised/Basys_3_LCD_Example_Revised/LCD/Counter_99_00/Counter_99_00.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter_99_00.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Counter_99_00.tcl
