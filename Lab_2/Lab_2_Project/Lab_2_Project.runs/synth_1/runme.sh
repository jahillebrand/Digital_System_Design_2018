...
HD_PWD='/home/exposedbuckle48/Documents/Semester_5/DSD/Lab_2/Lab_2_Project/Lab_2_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Add_rca_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Add_rca_16.tcl
